...
urlpatterns = [
    ...
    path("audits/<int:audit_id>/report", audit_report_pdf, name="audit_report_pdf_legacy"),
    path("audits/<int:audit_id>/report.pdf", audit_report_pdf, name="audit_report_pdf"),
