  ...
  return (
    <>
      ...
      <PageTransition className="flex-1 overflow-y-auto p-4 md:p-8">
        <div className="rounded-xl border border-slate-100 bg-white p-6 shadow-card dark:border-slate-800 dark:bg-[#161e27]">
          ...
          {incident ? (
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div className="flex justify-end gap-3 pt-2">
                ...
                <button
                  className="rounded-lg bg-professional-green px-4 py-2 text-sm font-semibold text-white transition-colors hover:bg-yellow-700 disabled:opacity-60"
                  disabled={!canSubmit}
                  type="submit"
                >
